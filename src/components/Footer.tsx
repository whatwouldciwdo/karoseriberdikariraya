...
export default function Footer() {
  return (
    <footer className="relative w-full bg-surface-container-lowest overflow-hidden border-t border-outline-variant/10">
      <div className="absolute inset-0 opacity-[0.15] pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, var(--color-outline-variant) 1px, transparent 0)', backgroundSize: '40px 40px' }}></div>
      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-margin-desktop py-20 z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="flex flex-col space-y-4">
            <h3 className="font-headline-md text-xl text-primary font-bold tracking-wider mb-2">Navigasi</h3>
          ...
          {/* Hubungi Kami */}
          <div className="flex flex-col space-y-4">
            <h3 className="font-headline-md text-xl text-primary font-bold tracking-wider mb-2">Hubungi Kami</h3>
        ...
        <div className="border-t border-outline-variant/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-on-surface-variant font-body-sm flex flex-col md:flex-row items-center gap-2 text-center md:text-left min-w-0 w-full md:w-auto">
            <MapPin size={16} className="hidden md:block text-primary shrink-0" />
