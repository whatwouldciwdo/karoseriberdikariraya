                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      <h3 className="text-lg md:text-xl font-semibold text-primary mb-3 leading-snug group-hover:text-primary transition-colors line-clamp-2 break-words">{rel.title}</h3>
                      <p className="text-sm md:text-base text-on-surface-variant leading-relaxed line-clamp-2 mb-4 flex-1 break-words">{rel.desc}</p>
