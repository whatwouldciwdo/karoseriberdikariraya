            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-20">
              {contactMethods.map((m, idx) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group flex items-start gap-5 bg-surface-container-high rounded-2xl p-6 border border-outline-variant/15 hover:border-primary/20 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5 transition-all duration-300 cursor-pointer"
                >
                  <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-300 shrink-0 ${m.icon === Phone ? "bg-emerald-500/10 text-emerald-500" : "bg-primary/5 text-primary"}`}>
                    {m.icon === Phone ? (
