        ...
        <section className="px-6 md:px-margin-desktop py-20 md:py-28">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="font-headline-lg text-3xl md:text-4xl text-white mb-4">Cara Menghubungi Kami</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-20">
              {contactMethods.map((m, idx) => (
                ...
                >
                  <div className="w-14 h-14 bg-secondary-container/10 group-hover:bg-secondary-container rounded-2xl flex items-center justify-center transition-all duration-300 shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="font-headline-sm text-white text-base mb-1 truncate">{m.value}</p>
                    <p className="font-body-md text-secondary-container text-sm">{m.sub}</p>
                  </div>
              ...
              <div className="bg-surface-container-high rounded-3xl p-8 border border-white/5 shadow-sleek">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <button
                      type="submit"
                      className="flex items-center justify-center gap-3 bg-secondary-container text-white py-4 rounded-full font-label-md text-label-md hover:brightness-110 transition-all active:scale-95 shadow-lg shadow-secondary-container/20 w-full group"
                    >
