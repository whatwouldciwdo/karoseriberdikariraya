      ...
      <main className="relative bg-background px-6 md:px-margin-desktop py-20 md:py-32 space-y-20 md:space-y-32 overflow-hidden">
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-8">
            ...
            <div className="pt-4">
              <button className="bg-secondary-container text-white px-8 py-4 rounded-full font-label-md text-label-md hover:brightness-110 transition-all active:scale-95 flex items-center gap-2 group shadow-lg shadow-secondary-container/20 w-fit">
                Selengkapnya
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="flex flex-col space-y-4">
              <a href="https://wa.me/6281291578404" target="_blank" rel="noreferrer" className="flex items-center gap-4 bg-surface-container hover:bg-surface-container-high p-4 rounded-2xl border border-white/5 transition-colors group">
                <div className="w-12 h-12 bg-secondary-container/10 group-hover:bg-secondary-container rounded-full flex items-center justify-center transition-colors">
                  <Phone className="text-secondary-container group-hover:text-white" size={24} />
                </div>
                <span className="font-body-lg text-lg text-white group-hover:text-secondary-container transition-colors">+62 812-9157-8404</span>
              </a>
              ...
              <a href="https://wa.me/6282113484129" target="_blank" rel="noreferrer" className="flex items-center gap-4 bg-surface-container hover:bg-surface-container-high p-4 rounded-2xl border border-white/5 transition-colors group min-w-0">
                ...
                <span className="font-body-lg text-lg text-white group-hover:text-secondary-container transition-colors">+62 821-1348-4129</span>
              </a>
