...
export const services: ServiceDetail[] = [
  {
    ...
    heroImg: "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=1600&q=80",
    aboutImg: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1200&q=80",
    heroAlt: "Karoseri box aluminium terpasang pada truck distribusi barang",
    aboutAlt: "Detail panel dinding box aluminium yang ringan dan tahan karat",
    icon: "Package",
    metaDescription:
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=1200&q=80",
    heroImg: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=1600&q=80",
    aboutImg: "https://images.unsplash.com/photo-1580674285054-bed31e145f59?w=1200&q=80",
    heroAlt: "Karoseri box freezer pada truck pengiriman produk rantai dingin",
    aboutAlt: "Interior box freezer dengan insulasi tebal dan lantai food grade",
    icon: "Snowflake",
    metaDescription:
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1530046339160-ce3e530c7d2f?w=1200&q=80",
    heroImg: "https://images.unsplash.com/photo-1530046339160-ce3e530c7d2f?w=1600&q=80",
    aboutImg: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1200&q=80",
    heroAlt: "Hydraulic system truck bekerja mengangkat bak dump truck",
    aboutAlt: "Teknisi memeriksa komponen hydraulic pump dan cylinder truck",
    icon: "Settings",
    metaDescription:
  ...
  },
  {
    ...
    title: "Repair & Custom Body",
    shortTitle: "Repair & Custom Body",
    tagline: "Perbaikan & Modifikasi Sesuai Kebutuhan",
    desc: "Perbaikan dan custom body kendaraan niaga sesuai spesifikasi dan kebutuhan operasional Anda. Kami menangani berbagai jenis kerusakan body, modifikasi, hingga penyesuaian fungsi kendaraan agar kembali prima dan sesuai kebutuhan bisnis.",
    img: "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=1200&q=80",
    heroImg: "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=1600&q=80",
    aboutImg: "https://images.unsplash.com/photo-1632823471565-1ecdf5c6da05?w=1200&q=80",
    heroAlt: "Proses repair dan custom body kendaraan niaga di workshop",
    aboutAlt: "Teknisi mengerjakan perbaikan dan modifikasi body truck",
    icon: "Wrench",
    metaDescription:
      "Jasa repair & custom body kendaraan niaga di Bekasi & JABODETABEK. Perbaikan body penyok, modifikasi fungsi, repaint, hingga restorasi. Spare part berkualitas dan bergaransi.",
    keywords: [
      "repair body truck",
    ...
    serviceType: "Commercial Vehicle Body Repair & Customization",
    highlights: [
    ...
    intro: {
      heading: "Mengembalikan Kondisi Prima dan Menyesuaikan Fungsi Kendaraan Niaga Anda",
      paragraphs: [
        "Kendaraan niaga bekerja keras setiap hari, sehingga kerusakan body, penyok, hingga korosi adalah hal yang wajar terjadi. Membiarkannya terlalu lama dapat menurunkan nilai kendaraan dan mengganggu operasional bisnis.",
        "Berdikari Raya Service menangani perbaikan dan kustomisasi body kendaraan niaga secara menyeluruh, mulai dari analisa kerusakan, penggantian komponen, modifikasi fungsi, hingga repaint. Setiap pengerjaan disertai garansi agar Anda tenang.",
      ],
    },
    ...
    painPoints: [
      ...
      "Kebutuhan modifikasi fungsi agar sesuai operasional bisnis.",
    ...
    features: [
      "Analisa kerusakan gratis",
      "Spare part berkualitas",
      "Modifikasi custom sesuai kebutuhan",
      "Garansi perbaikan",
    ],
    benefits: [
      { title: "Kembali Prima", desc: "Perbaikan menyeluruh mengembalikan kekuatan dan tampilan body kendaraan." },
      { title: "Custom Fleksibel", desc: "Modifikasi disesuaikan dengan kebutuhan operasional bisnis Anda." },
      { title: "Bergaransi", desc: "Setiap pengerjaan disertai garansi untuk ketenangan Anda." },
    ],
    useCases: ["Body penyok & rusak", "Modifikasi fungsi", "Repaint & finishing", "Restorasi kendaraan niaga"],
    process: [
      ...
      { step: "4", title: "Pengerjaan Body", desc: "Perbaikan struktur, modifikasi, atau kustomisasi sesuai spesifikasi." },
  ...
  },
  {
    ...
    heroImg: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1600&q=80",
    aboutImg: "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=1200&q=80",
    heroAlt: "Karoseri box besi baja plat tebal terpasang pada truck angkut industri",
    aboutAlt: "Detail rangka baja box besi yang kokoh dengan finishing cat anti-karat",
    icon: "Box",
    metaDescription:
  ...
  },
  {
    ...
    aboutImg: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1200&q=80",
    heroAlt: "Karoseri dump truck mengangkat bak untuk membongkar material proyek",
    aboutAlt: "Detail bak baja tebal dump truck dengan sistem hidrolik pengangkat",
    icon: "Hammer",
    metaDescription:
  ...
  },
  {
    ...
    aboutImg: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1200&q=80",
    heroAlt: "Karoseri fuel truck untuk distribusi BBM dengan tangki baja terstandar",
    aboutAlt: "Detail sistem perpipaan dan tangki fuel truck sesuai standar keselamatan",
    icon: "Fuel",
    metaDescription:
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1632833239869-a37e3a5806d2?w=1200&q=80",
    heroImg: "https://images.unsplash.com/photo-1632833239869-a37e3a5806d2?w=1600&q=80",
    aboutImg: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1200&q=80",
    heroAlt: "Karoseri lube truck untuk servis pelumasan alat berat di lapangan tambang",
    aboutAlt: "Detail multi-kompartemen pelumas dan pompa hidrolik pada lube truck",
    icon: "Droplets",
    metaDescription:
  ...
  },
  {
    ...
    heroImg: "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=1600&q=80",
    aboutImg: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1200&q=80",
    heroAlt: "Karoseri water sprayer truck menyemprot air untuk pengendalian debu proyek",
    aboutAlt: "Detail tangki air dan nozzle sistem semprotan water sprayer truck",
    icon: "CloudRain",
    metaDescription:
  ...
  },
  {
    ...
    heroImg: "https://images.unsplash.com/photo-1519003722824-194d4455a60c?w=1600&q=80",
    aboutImg: "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=1200&q=80",
    heroAlt: "Karoseri wing box dengan bukaan sayap hidrolik terbuka pada truck distribusi",
    aboutAlt: "Detail mekanisme hidrolik bukaan sayap wing box untuk bongkar muat cepat",
    icon: "Truck",
    metaDescription:
  ...
  },
  {
    ...
    heroImg: "https://images.unsplash.com/photo-1563492065599-3520f775eeed?w=1600&q=80",
    aboutImg: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1200&q=80",
    heroAlt: "Karoseri three way truck membongkar muatan ke salah satu dari tiga arah",
    aboutAlt: "Detail sistem hidrolik dan engsel bak three way truck yang fleksibel",
    icon: "Replace",
    metaDescription:
  ...
  },
  {
    ...
    shortTitle: "Karoseri Truck Tangki",
    tagline: "Angkut Muatan Cair dengan Aman",
    desc: "Pembuatan karoseri truck tangki untuk berbagai kebutuhan muatan cair industri, mulai dari air bersih, minyak goreng, hingga bahan kimia non-B3. Tersedia material food grade dengan lapisan dalam anti-korosi, dirancang untuk berbagai kapasitas sesuai kebutuhan distribusi cairan Anda.",
    img: "https://images.unsplash.com/photo-1545193544-312983719627?w=1200&q=80",
    heroImg: "https://images.unsplash.com/photo-1545193544-312983719627?w=1600&q=80",
    aboutImg: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1200&q=80",
    heroAlt: "Karoseri truck tangki untuk distribusi muatan cair industri",
    aboutAlt: "Detail tangki dengan lapisan dalam anti-korosi untuk muatan cair food grade",
    icon: "Cylinder",
    metaDescription:
      "Jasa pembuatan karoseri truck tangki untuk muatan cair di Bekasi & JABODETABEK. Material food grade, lapisan anti-korosi, berbagai kapasitas untuk air, minyak, & kimia non-B3. Konsultasi gratis.",
    keywords: [
      "karoseri truck tangki",
      "jasa truck tangki Bekasi",
      "tangki air bersih truck",
      "truck tangki minyak goreng",
      "pembuatan truck tangki",
      "karoseri tangki JABODETABEK",
    ],
    serviceType: "Tank Truck Body Manufacturing",
    highlights: [
      "Material Food Grade Tersedia",
      "Lapisan Dalam Anti-Korosi",
      "Berbagai Kapasitas",
      "Konstruksi Aman",
      "Survey & Konsultasi Gratis",
    ],
    intro: {
      heading: "Truck Tangki untuk Distribusi Beragam Muatan Cair Industri",
      paragraphs: [
        "Distribusi muatan cair seperti air bersih, minyak goreng, hingga bahan kimia non-B3 membutuhkan tangki dengan material dan lapisan yang tepat. Pemilihan material yang keliru dapat menyebabkan kontaminasi, korosi, hingga menurunkan kualitas muatan yang diangkut.",
        "Berdikari Raya Service membuat karoseri truck tangki dengan pilihan material food grade, lapisan dalam anti-korosi, serta konstruksi yang aman dan presisi. Kami menyesuaikan kapasitas dan spesifikasi tangki dengan jenis cairan dan kebutuhan distribusi operasional Anda.",
      ],
    },
    painPointHeading: "Cocok untuk Anda yang Membutuhkan",
    painPoints: [
      "Distribusi muatan cair seperti air, minyak, atau kimia non-B3.",
      "Tangki food grade yang aman untuk cairan konsumsi.",
      "Lapisan dalam anti-korosi agar muatan tetap berkualitas.",
      "Kapasitas tangki yang fleksibel sesuai kebutuhan.",
      "Konstruksi tangki presisi untuk mencegah kebocoran.",
      "Unit andal untuk operasional distribusi cairan harian.",
    ],
    features: [
      "Material food grade tersedia",
      "Lapisan dalam anti-korosi",
      "Berbagai kapasitas",
      "Konstruksi anti-bocor",
    ],
    benefits: [
      { title: "Aman untuk Muatan", desc: "Material food grade dan anti-korosi menjaga kualitas cairan." },
      { title: "Kapasitas Fleksibel", desc: "Tangki dibuat dalam berbagai kapasitas sesuai kebutuhan Anda." },
      { title: "Anti Kebocoran", desc: "Konstruksi presisi memastikan tangki aman dari kebocoran." },
    ],
    useCases: ["Distribusi air bersih", "Minyak goreng & CPO", "Bahan kimia non-B3", "Cairan industri"],
    process: [
      { step: "1", title: "Konsultasi Kebutuhan", desc: "Memahami jenis cairan, volume, dan spesifikasi material tangki." },
      { step: "2", title: "Survey & Pengukuran", desc: "Pengukuran chassis dan penentuan kapasitas tangki yang sesuai." },
      { step: "3", title: "Penawaran & Desain", desc: "Menyusun desain tangki, pilihan material, dan penawaran harga." },
      { step: "4", title: "Produksi Tangki", desc: "Pembuatan tangki dengan lapisan anti-korosi sesuai spesifikasi." },
      { step: "5", title: "Instalasi & Perpipaan", desc: "Pemasangan tangki pada chassis dan sistem perpipaan." },
      { step: "6", title: "Uji Kebocoran & Serah Terima", desc: "Pengujian kebocoran sebelum unit diserahkan siap beroperasi." },
    ],
  },
];
